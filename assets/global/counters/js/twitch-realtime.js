...
window.onload = () => {
	...
	document.getElementById('embed').href = "/twitch-realtime/embed?u="+user
...
Twitch.GoalManager = {
    load: function(a) {
		...
		Twitch.UpdateManager.updateGoal(goal);
    }
}

function search() {
    window.location.href = '/twitch-realtime/?u=' + document.getElementById('search').value.replace(" ", "");
}
