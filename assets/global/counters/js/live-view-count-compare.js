...
YT.manager = {
  ...
  $.getJSON(`https://www.googleapis.com/youtube/v3/videos?part=statistics,snippet&id=${video1}%2C${video2}&key=AIzaSyAuecFZ9xJXbGDkQYWBmYrtzOGJD-iDIgI`, function(data) {
    ...
    if (!localViewCount2) {
      localStorage.setItem('likeCount2-' + channelId2, parseInt(likes2));
      localStorage.setItem('viewCount2-' + channelId2, parseInt(views2));
    }
  ...
  getDataBackup: function() {
      $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=statistics,snippet&id='+video1, function(data) {
        $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=statistics,snippet&id='+video2, function(data2) {
  ...
  searchVideo: function(e) {
    if(e == 1) {
      ...
      $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=video&q=' + searchQuery + '&key=AIzaSyAuecFZ9xJXbGDkQYWBmYrtzOGJD-iDIgI', function(data) {
          ...
          $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=search&part=video&q='+ searchQuery, function(data) {
