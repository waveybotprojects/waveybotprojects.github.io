...
window.onload = () => {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/videos?part=statistics,snippet&id='+video1+','+video2+'&key='+rightKey, function(data) {
        ...
        if (rightKeys.length == 0) {
            $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=statistics&id='+video1, function(data) {
                $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=statistics&id='+video2, function(data2) {
        ...
        $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=snippet&id='+video1, function(data) {
            $.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=video&part=snippet&id='+video2, function(data2) {
