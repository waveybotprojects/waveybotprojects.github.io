...
function getDataBackup() {
  $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=snippet&id='+user1, function(data1) {
    $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=snippet&id='+user2, function(data2) {
...
function getSubData() {
  ...
  if (isUsingEstimatedCounters1 && !isUsingEstimatedCounters2) {
    $.getJSON("https://api.livecounts.io/yt_subs", function(data) {
      $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=statistics&id='+user2, function(data2) {
  ...
  if (!isUsingEstimatedCounters1 && isUsingEstimatedCounters2) {
    $.getJSON("https://api.livecounts.io/yt_subs", function(data) {
      $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=statistics&id='+user1, function(data2) {
  ...
  if (!isUsingEstimatedCounters1 && !isUsingEstimatedCounters2) {
    $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=statistics&id='+user1, function(data) {
      $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=channel&part=statistics&id='+user2, function(data2) {
...
function searchUser1() {
  ...
  if (change_user.value != 0) {
    $.getJSON('https://ytdata-livecounts-io.glitch.me/yt_data?type=search&part=channel&maxResults=5&q='+change_user,function(data) {
