...
function getDataBackup() {
	$.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=channel&part=snippet,statistics&id='+user,function(data) {
...
function searchUser() {
	...
	$(".channel-list").html("");
	$.getJSON('https://amazing-app-aww-man.glitch.me/yt_data?type=search&part=channel&maxResults=5&q='+value,function(data) {
